...
class HotelControllerTest {
  ...
  @Test
  @DisplayName("When hotel is requested by Id then it will be returned")
  void getHotelByIdRequested() throws Exception {
    mockMvc
            .perform(get("/hotel/1"))
            .andExpect(status().is2xxSuccessful());
  }
  ...
  @Test
  @DisplayName("To find three nearest Hotels")
  void findThreeNearestHotels() throws Exception {
    mockMvc
            .perform(get("/hotel/search/1?sortBy=5"))
            .andExpect(status().is2xxSuccessful())
